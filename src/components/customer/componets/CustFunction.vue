<template>
    <div class="chat-function-box" :style="{ backgroundColor: funColor.value }">
        ...
        <div class="chat-function">
            ...
            <div class="chat-function-right">
                <slot name="email-icon">
                    <svg @click="toggleEmail" style="cursor: pointer" width="20" height="14" viewBox="0 0 20 14" fill="none"
