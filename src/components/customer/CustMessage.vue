    ...
    <template #content>
      ...
      <div class="chat-function functon-phone" :class="{ 'function-color': isShowEmojio }">
        ...
        <div class="chat-function-right">
          <img
            class="function-right-img"
            src="@/assets/img/customerImg/link.png"
            alt=""
            srcset=""
          />
          <img
            class="function-right-img"
            src="@/assets/img/customerImg/message.png"
...
/* 输入内容... */ position: absolute; width: 92px; height: 27px; /* web/web正文文本 */ font-family:
'Noto Sans TC'; font-style: normal; font-weight: 400; font-size: 18px; line-height: 27px; /*
identical to box height, or 150% */ letter-spacing: 0.04em; /* 灰度/3 */ color: #929292;
